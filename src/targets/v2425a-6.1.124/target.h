...
/* ---- Function address macros (BASE + OFF) ---- */
#define ASHMEM_FOPS (KIMAGE_TEXT_BASE + ASHMEM_FOPS_OFF)
...
/* ---- ASHMEM_MISC_FOPS: нет в 6.1.124 → используем ASHMEM_FOPS как fallback ---- */
#define ASHMEM_MISC_FOPS_OFF ASHMEM_FOPS_OFF
#define ASHMEM_MISC_FOPS (KIMAGE_TEXT_BASE + ASHMEM_MISC_FOPS_OFF)

/* ---- Page layout offsets (одинаковые для всех target) ---- */
...
/* ---- workqueue symbols ---- */
#define SYSTEM_UNBOUND_WQ_OFF 0x0218ae60ULL
#define SYSTEM_UNBOUND_WQ (KIMAGE_TEXT_BASE + SYSTEM_UNBOUND_WQ_OFF)
#define SYSTEM_WQ_OFF 0x0218ae48ULL
#define SYSTEM_WQ (KIMAGE_TEXT_BASE + SYSTEM_WQ_OFF)

/* ---- SLIDE_PSELECT_NFDS (используется в app коде) ---- */
#define SLIDE_PSELECT_NFDS 16
